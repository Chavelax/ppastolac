        ...
        <div class="page-sidebar navbar-collapse collapse">
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="nav-item start active open">
                    <a href="?mod=principal1" class="nav-link nav-toggle">
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item start ">
                            <a href="?mod=principal1" class="nav-link ">
                        ...
                        <li class="nav-item start ">
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item start ">
                                    <a href="?mod=MateriaPri" class="nav-link ">
                                        <i class="fa fa-truck"></i>
                                        <span class="title">Lista de Materia Prima</span>
                                    </a>
                                </li>
                                <li class="nav-item start ">
                                    <a href="?mod=entradaM" class="nav-link ">
                                        <i class="fa fa-search-plus"></i>
                                        <span class="title">Entradas Materia Prima</span>

                                    </a>
                                </li>
                                <li class="nav-item start ">
                                    <a href="?mod=salidaM" class="nav-link ">
                                        <i class="fa fa-search-plus"></i>
                            ...
                            <ul class="sub-menu">
                                <li class="nav-item start ">
                                    <a href="?mod=productos" class="nav-link ">
                                        ...
                                        <span class="title">Lista Productos Elaborados</span>
                                    </a>
                                </li>
                                <li class="nav-item start ">
                                    <a href="?mod=entradas" class="nav-link ">
                                        <i class="fa fa-search-plus"></i>
                                ...
                                <li class="nav-item start ">
                                    <a href="?mod=salida" class="nav-link ">
                                        <i class="fa fa-search-plus"></i>
